					...
					<div className="flex items-center justify-between h-16 md:h-20">
						...
						<div className="flex-1 md:flex-none md:absolute md:left-1/2 md:transform md:-translate-x-1/2">
							<Link href="/" className="flex flex-col items-center">
								...
								<span className="text-xs text-black font-light tracking-wider">
									LUXE BRAND
								</span>
							</Link>
						</div>
						...
						<div className="hidden md:flex items-center space-x-6 lg:space-x-8">
							<Link
								...
								className="text-black hover:text-gray-600 transition-colors font-medium text-sm lg:text-base uppercase tracking-wide"
							>
								WOMEN
							</Link>
							<Link
